...
const Footer=()=>{
    ...
    return (<>
    <div className="absolute shp z-10 w-full flex flex-row bg-white justify-between items-center rounded-t-2xl p-4  rounded-md bottom-0">
