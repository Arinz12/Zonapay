...
const Footer=()=>{
    ...
    return (<>
    <div className="fixed shp z-10 w-full flex flex-row bg-white justify-between items-center rounded-t-2xl p-4  rounded-md bottom-0">
        {(router.pathname=="/dashboard")?   <div className="flex flex-col justify-center items-center" ><Home className="text-blue-600 bg-none"  sx={{fontSize:"26px"}}/><div className="rubik-b text-blue-600">Home</div> </div> : <Link href={"/dashboard"}>{<div className="flex flex-col justify-center items-center" > <Home  sx={{fontSize:"30px",color:"#36454F"}}/>
