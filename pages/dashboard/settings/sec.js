...
<div style={{fontSize:"",height:"100vh"}} className="relative min-h-screen mx-auto bg-white gap-8 text-white flex flex-col  items-start">
   <div style={{fontSize:"30px"}} className="mt-0 mb-8 text-center bg-white border-b-2 border-blue-500 text-blue-600 w-full rounded-b-2xl px-4 py-8 rubik-h ">Security</div>
