...
<div className="absolute w-full flex bottom-1 mx-auto justify-center text-center"><Button endIcon={<ArrowForward/>} className="p-5 w-full rounded-full bg-blue-500 " variant="contained" type="submit">Continue</Button></div>
</form>
</div>
</>)
}
