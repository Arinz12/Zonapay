...
setCp(selected.value);
               ...
               <input style={{fontSize:"20px",backgroundColor:"whitesmoke"}} onKeyUp={val}  id="iuc" className="border-0 rounded-2xl p-3 border-blue-600 focus:outline-none rubik-h font-bold" type="number" name="iuc" placeholder="Decoder number"/> <span style={{color:"blue"}} id="user" className="hidden font-bold"></span></div>
