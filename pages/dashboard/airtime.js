...
if(rep.ok){
  ...
  console.log("error wrong pin")
    ...
    <div style={{backgroundColor:"whitesmoke",height:"100dvh"}} className="flex flex-col items-center mx-auto justify-start w-full md:w-9/12">
        ...
        <div style={{fontSize:"26px"}} className="rubik-h w-full text-white bg-blue-500 px-4 py-7 flex flex-row justify-start gap-4 items-center rounded-b-3xl  mb-14">
...
{ loading?  <Delay/> : <Button id="ready" className="text-white mt-12 p-4" disabled={enable} type="submit" variant="contained" endIcon={<ArrowForward/> } sx={{backgroundColor:"#1E3A5F",textTransform:"none",borderRadius:"30px"  }} >proceed</Button>}
</form>
