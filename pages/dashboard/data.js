...
if(processed){
  ...
  {sucessfull? <div style={{height:"100lvh",width:"100vw"}} className="flex  flex-row items-center justify-center">
    ...
    <div className="flex flex-col items-center mx-auto justify-center w-full md:w-9/12">
        <div style={{fontSize:"30px"}} className="rubik-h mb-16">Data purchase</div>
...
{ (net=="mtn")? <div className="pt-7 ">
    <label for="amt" className="rubik-h pb-3">Plan  </label>
...
{ loading? <Button variant="contained" className="text-white mt-12 p-4"  sx={{backgroundColor:"#1E3A5F",textTransform:"none",borderRadius:"30px"}}>Processing...</Button> : <Button className="text-white mt-12 p-4" disabled={enable} type="submit" variant="contained" endIcon={<ArrowForward/> } sx={{backgroundColor:"#1E3A5F",textTransform:"none",borderRadius:"30px"  }} >proceed</Button>}
</form>
