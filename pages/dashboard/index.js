        ...
        <div className=''>
            <Carousel animation='slide' autoPlay={false} navButtonsAlwaysVisible={false} activeIndicatorIconButtonProps={{
                ...
                <div className='h-36 ml-2 mr-2 rounded-3xl p-4 bg-blue-600 flex flex-row items-center justify-between'>
                    ...
                    <Link href={"http://localhost:3000/dashboard/history"}>{<div className='rubik-b text-white'>Txn History</div>}</Link>
 <Link href={"http://localhost:3000/dashboard/history"}>{<History begin={"txn"} sx={{color:"white",fontSize:"30px"}}/>}</Link></div>
                </div>
