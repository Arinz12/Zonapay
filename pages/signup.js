...
<Box sx={{height:"100svh",backgroundColor:"transparent",backgroundSize:"cover",backgroundRepeat:"no-repeat"}} className="flex flex-col items-center justify-center">
    ...
    <div style={{backgroundColor:"transparent",fontSize:"35px"}} className="  gap-2 flex flex-col h-5/6 mx-auto  md:w-6/12 w-11/12 border-0   border-blue-600 rounded-3xl  items-center">
