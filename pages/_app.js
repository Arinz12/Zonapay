...
return (<>
  <div className={` w-full ${(router.pathname.includes("dashboard"))? 'sm:flex sm:flex-row parentt' : "" } page-container ${shouldAnimate ? (transitioning&&(router.pathname=="/dashboard") ? "fade-out2": transitioning? 'fade-out1' : 'fade-in') : ''}`}>
  <Head>
