...
<span  className="monomaniac-one-regular" style={{transitionDelay:"350ms"}}>d</span>
    ...
    <span className="absolute right-0 top-1/4" >{visible? <Visibility sx={{}} className="text-black" onClick={()=>{setVis(false)}}/>:<VisibilityOff sx={{}} className="text-black" onClick={()=>{setVis(true)}}/>}</span>
</div>
