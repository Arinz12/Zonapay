...
<span  className="monomaniac-one-regular" style={{transitionDelay:"350ms"}}>d</span>
    ...
    <span className="absolute right-0 top-2/4" >{visible? <Visibility sx={{height:"24px"}} className="text-black" onClick={()=>{setVis(false)}}/>:<VisibilityOff sx={{height:"24px"}} className="text-black" onClick={()=>{setVis(true)}}/>}</span>
</div>
