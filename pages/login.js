...
<Box sx={{height:"100svh",backgroundColor:"white",backgroundSize:"cover",backgroundRepeat:"no-repeat"}} className="flex flex-col items-center justify-center">
    <div style={{backgroundColor:"white",backdropFilter:"blur(9px)",fontSize:"35px"}} className=" pt-20 gap-4 flex flex-col h-5/6 mx-auto md:w-6/12 w-11/12  md:border-4 border-0 border-blue-500 rounded-3xl  items-center">
...
<button className="mt-4  bg-blue-500" type="submit"> 
        ...
        <div className="text-black monomaniac-one-regular rubik-h " style={{fontSize:"16px"}}>
            Don't have an account yet? then <span className="text-blue-500 underline" > <Link href="https://zonapay.onrender.com/signup">Signup</Link></span>
        </div>
